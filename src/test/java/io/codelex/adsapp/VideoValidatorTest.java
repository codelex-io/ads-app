...
//        //given
//        List<String> ads = Arrays.asList(new Ad(LocalDate.of(2019, 4, 1), LocalTime.of(6, 30), 30, "M11016"));
...
//        //given
//        List<String> ads = Arrays.asList(LocalDate.of(2019, 4, 1), LocalTime.of(6, 30), 30, "M11016"));
